...
class Pokemon(models.Model):
    ...
    image = models.ImageField('Картинка', upload_to='pokemon_map/pokemon_entities/', blank=True, null=True,
                              default=None)
    description = models.TextField('Описание',blank=True, null=True, default='Информации о покемоне нет')
    title_en = models.CharField('Имя по английски',max_length=200, blank=True, null=True)
    title_jp = models.CharField('Имя по японски',max_length=200, blank=True, null=True)
